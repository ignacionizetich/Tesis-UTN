...
public class MavenWrapperDownloader {
    ...
    /**
     * Name of the property which should contain the final URL. We use a custom property name for the download URL to
     * avoid problems with older Maven versions on Mac.
     */
